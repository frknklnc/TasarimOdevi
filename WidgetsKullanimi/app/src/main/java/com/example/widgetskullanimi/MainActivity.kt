    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tasarim.slider.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            override fun onProgressChanged(p0: SeekBar?,p1: Int, p2: Boolean){
                tasarim.textViewSonuc.text = p1.toString()
        ...
        //edittext mask(maskeleme metodu)
        tasarim.buttonTarih.setOnClickListener {
            ...
            dp.setButton(DialogInterface.BUTTON_NEGATIVE,"iptal",dp)
            dp.show()
        }
        ...
        tasarim.buttonGoster.setOnClickListener {
            ...
            Log.e("Widgets","En son seçilen indeks : ${tasarim.spinner.selectedItemPosition}")
            Log.e("Widgets","En son seçilen indeks : ${ulkeler.get(tasarim.spinner.selectedItemPosition)}")
